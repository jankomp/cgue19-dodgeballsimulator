...
GLuint ParticleGenerator::loadDDS(const char * imagepath) {
...
*/
	...
	GLuint Texture = loadDDS("modells/particle.DDS");
...
void ParticleGenerator::del(float delta, Shader shader, glm::mat4 ProjectionMatrix, glm::mat4 ViewMatrix)
{
